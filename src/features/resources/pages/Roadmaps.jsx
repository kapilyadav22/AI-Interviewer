            ...
            >
              <div className="text-center mb-16">
                ...
                <h1 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-4 tracking-tight">
                  INTERVIEW MASTERY ROADMAPS
                </h1>
                <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto text-lg font-medium">
                  Advanced "Must-Know" technical blueprints for the final push
            ...
            >
              ...
              <div className="flex items-center gap-6 mb-12">
                <div className="w-20 h-20 rounded-3xl bg-primary-600 flex items-center justify-center text-white shadow-xl shadow-primary-100 dark:shadow-none">
                  {React.createElement(ICON_MAP[selectedCategory.icon], {
                    size: 36,
                  })}
                </div>
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 font-bold">
                    {selectedCategory.items.length} ADVANCED BLUEPRINTS
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-8">
                {selectedCategory.items.map((item, idx) => (
                  <div
                    key={idx}
                    className="bg-white dark:bg-slate-800 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden"
                  >
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2">
                                {item.components.map((c, i) => (
                                  <span
                                    key={i}
                                    className="px-4 py-2 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-sm font-bold"
                                  >
                                    {c}
                                  </span>
                                ))}
                          ...
                          {item.tradeoffs && (
                            <div className="p-6 bg-amber-50 dark:bg-amber-900/10 rounded-2xl border border-amber-100 dark:border-amber-900/30">
                              <h4 className="text-amber-800 dark:text-amber-500 text-[10px] uppercase font-black tracking-widest mb-2">
                                Trade-offs
                              </h4>
