...
import { 
    Search, Infinity, ShoppingCart, 
    Layout as LayoutIcon, Tv, ArrowLeft,
    Clock, Trophy, Target, Apple, Cpu, Sparkles,
    Car, CreditCard, Map, Home as HomeIcon, ShieldCheck,
    Network, Code2, UtensilsCrossed, ShoppingBag, Bike,
    Briefcase, Building2, Rocket, Palette, Cloud, Database,
    Users2, HardDrive, Smartphone, Wallet
} from 'lucide-react';
...
const CATEGORIES = [
    ...
    { id: 'product', label: 'Product Based', icon: <Building2 className="w-4 h-4" /> },
    { id: 'service', label: 'Service Based', icon: <Briefcase className="w-4 h-4" /> },
...
export const CompanySprints = () => {
    ...
    const filteredCompanies = Object.values(COMPANY_DATA).filter(company => 
        activeTab === 'all' || company.type === activeTab
    );
            ...
            <div className="max-w-6xl mx-auto py-12 px-4">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    <div className="flex items-center">
                        ...
                        <div>
                            <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">COMPANY SPRINTS</h1>
                            <p className="text-slate-500 dark:text-slate-400 font-medium whitespace-nowrap">Master the interview style of industry leaders.</p>
                        </div>
                    </div>
                            ...
                            return (
                                ...
                                >
                                    <div className="p-8 flex-1">
                                        ...
                                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">{company.title}</h3>
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center text-sm text-slate-500 dark:text-slate-400 font-medium">
                                                <Target size={16} className="mr-2 text-slate-400 dark:text-slate-500" />
                                                High Relevancy
                                            </div>
                                            <div className="flex items-center text-sm text-slate-500 dark:text-slate-400 font-medium">
                                                <Trophy size={16} className="mr-2 text-slate-400 dark:text-slate-500" />
                                                Expert Evaluation
                                            </div>
                                        </div>
                                    </div>
