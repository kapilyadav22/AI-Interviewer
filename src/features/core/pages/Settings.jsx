...
import { Save, Volume2, Play, Key } from "../../../shared/components/Icons";
...
export function Settings() {
  ...
  const [testText] = useState(
    "Hello! This is how I will sound during your interview.",
  );
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">
                  Required for AI features like Resume Optimization.
                </p>
              </div>
              <Button
