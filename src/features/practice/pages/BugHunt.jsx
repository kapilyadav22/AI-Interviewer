        ...
        <AnimatePresence mode="wait">
          {gameState === "welcome" && (
            ...
            >
              ...
              <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-4 italic uppercase tracking-tighter">
                BUG HUNT: ULTIMATE
              </h1>
              <p className="text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
                Debug like a senior engineer! Choose your domain and fix
                critical production bugs under pressure. Featuring diverse
            ...
            >
              <div className="text-center mb-10">
                ...
                <p className="text-slate-500 dark:text-slate-400">
                  Each sprint consists of 10 randomized challenges.
                </p>
              </div>
                ...
                {Object.values(BUG_CATEGORIES).map((cat) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Button
                        variant="ghost"
                        className="w-full group-hover:bg-primary-600 group-hover:text-white border-primary-200 dark:border-primary-800 dark:text-slate-300"
                      >
                        START MISSION
                      </Button>
                    </motion.div>
              ...
              <div className="flex items-center justify-between bg-slate-900 text-white p-4 rounded-xl shadow-lg border-b-4 border-slate-700">
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span
                      className={`font-mono text-xl ${timeLeft < 10 ? "text-red-400" : ""}`}
                    >
                      {timeLeft}s
                    </span>
                  </div>
                ...
                <div className="hidden sm:block">
                  <span className="bg-slate-800 px-3 py-1 rounded-full text-xs font-bold border border-slate-700 uppercase tracking-widest text-primary-400">
                    {BUG_CATEGORIES[selectedCategory]?.title ||
                      selectedCategory}
                  </span>
                </div>
                <div className="hidden lg:flex items-center gap-2 bg-slate-800 px-3 py-1 rounded-full border border-slate-700">
                  ...
                  <div className="w-24 h-1.5 bg-slate-700 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${((currentLevel + 1) / currentQuestions.length) * 100}%`,
                      }}
                    />
                  </div>
                  <span className="text-[10px] font-mono text-slate-400">
                    {currentLevel + 1}/{currentQuestions.length}
                  </span>
                </div>
                <Button
                  variant="ghost"
              ...
              <div className="bg-[#1e1e1e] rounded-2xl overflow-hidden shadow-2xl border border-slate-800 group relative">
                ...
                <AnimatePresence>
                  {gameState === "result" && (
                    ...
                    >
                      <div
                        className={`flex items-start gap-4 p-4 rounded-xl mb-6 ${isCorrect ? "bg-green-500/10 border border-green-500/20" : "bg-red-500/10 border border-red-500/20"}`}
                      >
                        {isCorrect ? (
                      ...
                      <Button onClick={nextLevel} className="w-full">
                        {currentLevel < currentQuestions.length - 1
          ...
          {gameState === "finish" && (
            ...
            >
              ...
              <p className="text-slate-500 dark:text-slate-400 uppercase tracking-widest text-sm font-bold mb-8">
                Performance Review Complete
              </p>

              <div className="grid grid-cols-2 gap-4 mb-10 text-left">
                <div className="bg-slate-50 dark:bg-slate-700 p-6 rounded-3xl border border-slate-100 dark:border-slate-600">
                  <div className="text-[10px] text-slate-400 dark:text-slate-500 uppercase font-black mb-1 tracking-widest">
                    Final Tech-Score
                  </div>
